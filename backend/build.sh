...
User = get_user_model()
username = os.environ.get('DJANGO_SUPERUSER_USERNAME', 'pratham')
email = os.environ.get('DJANGO_SUPERUSER_EMAIL', 'pratham@smartcart.com')
password = os.environ.get('DJANGO_SUPERUSER_PASSWORD', 'pratham123')
